...
def get_info():
    ...
    df_info_tse.columns = [x.replace(" ", "") for x in df_info_tse.columns]
    df_info_tse["公司代號"] = df_info_tse["公司代號"].str.replace(" ", "")
    ...
    df_info_otc.columns = [x.replace(" ", "") for x in df_info_tse.columns]
    df_info_otc["公司代號"] = df_info_otc["公司代號"].str.replace(" ", "")
